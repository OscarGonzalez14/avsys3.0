    ...
    foreach($datos as $row)
      {
        ...
        $sub_array[] = '<button type="button"  id="'.$row["id_usuario"].'" class="btn btn-edit btn-md edita_pacc bg-light" style="text-align:center" data-toggle="modal" data-target="#nuevo_usuario" data-backdrop="static" data-keyboard="false"><i class="fa fa-edit" aria-hidden="true" style="color:#006600"></i></button>';

        $sub_array[] = '<button type="button"  id="'.$row["id_usuario"].'" class="btn btn-edit btn-md edita_pacc bg-light" style="text-align:center" onClick="show_datos_paciente('.$row["id_usuario"].',\);" data-toggle="modal" data-target="#nuevo_usuario" data-backdrop="static" data-keyboard="false"><i class="fa fa-edit" aria-hidden="true" style="color:#006600"></i></button>';
