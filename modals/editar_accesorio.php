		...
		<section style="margin:15px">
			<div class="form-row">
				...
				<div class="form-group col-md-2">
					<label>Cod. Acc.</label>
					<input type="text" class="form-control" name="" id="cod_edit" onkeyup="mayus(this)">
				</div>
				...
				<div class="form-group col-md-5">
					<label>Marca</label>
					<select class="form-control" id="marca_edit">
				...
				<div class="form-group col-md-12">
					...
					<input type="text" class="form-control" name="" id="des_acc_edit" onkeyup="mayus(this)">
				</div>
