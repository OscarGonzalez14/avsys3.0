...
<div class="modal fade bd-example-modal-lg" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" id="listar_photosensibles_ventas" style="border-radius:0px !important;">
