function guardarUsuario(){
	...
	if (nom_user !="" || tel_user !="" || correo_user !"" || dir_user !"" || user !"" || pass_user !"" || fecha_ingreso !"" || cat_user !"" || est_user !""){
		$.ajax({
			url:"ajax/usuarios.php?op=guardar_usuario",
			method:"POST",
			data:{nom_user:nom_user, tel_user:tel_user, correo_user:correo_user, dir_user:dir_user, user:user, pass_user:pass_user, fecha_ingreso:fecha_ingreso, cat_user:cat_user, est_user:est_user},
			cache: false,
			dataType: "json",
